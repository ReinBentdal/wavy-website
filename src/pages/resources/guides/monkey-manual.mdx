...
Some of the type 1 functions are toggled on and off (HOLD and EFFECTS). Notice the light tower LED then blinking once when the function is activated and blinking twice when the function is deactivated.
