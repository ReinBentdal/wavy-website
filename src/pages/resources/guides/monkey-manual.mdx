...
**CATUION**: Make sure to distinguish between a short press and long press on CH key. Long pressing CH allows you to mute/unmute specific MIDI channels. Use the numbered keys to select a channel. 
