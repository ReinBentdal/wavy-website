...
<Accordion title="macOS">
  <NoteInfo>Bluetooth MIDI devices will not appear in system Bluetooth settings. Instead, macOS has it's own utility.</NoteInfo>

  We have developed _MIDI Connect_ which simplifies connections on macOS. And it's not limited to Wavy devices. This is the easiest way to manage your Bluetooth MIDI devices, however it is not required. If you instead prefer to not install anything, please skip to the below instructions.
