...
MONKEY supports a variety of hosts and works just great together with many types of devices. The connection process varies with the device you choose to use MONKEY with. For new users, we recommend starting with a mobile device. On mobile devices, it's typical for the music making apps to handle connections. This is contrary to desktop operating systems such as Windows and macOS, where you typically handle the connection through the OS.
