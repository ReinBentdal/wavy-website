...
## Connecting
<NoteInfo>Many operating systems does not let you connect to Bluetooth MIDI devices through system settings. Please check out the steps for your operating system below.</NoteInfo>
...
<Accordion title="macOS">
  {/* <NoteInfo>Bluetooth MIDI devices will not appear in system Bluetooth settings. Follow the steps below for </NoteInfo> */}
